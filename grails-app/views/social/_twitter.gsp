<div class="span3">
			...
			<ul class="carousel">
				<g:each var="index" in="${4..0}">
					<li class="testimonial">
						...
						<div class="testimonials-author"><a href="http://twitter.com/hackingmn">@HackingMN</a> <span id="time${index}"></span></div>
					</li>
				</g:each>
			</ul>
	...
	<r:script>
		...
		$.getJSON("https://api.twitter.com/1/statuses/user_timeline/hackingmn.json?count=5&include_rts=1&callback=?", function(data) {
			for(var i=0; i<5; i++) {
